    ...
    <div class="alert alert-primary" role="alert">
      <div class="alert-body">
        <strong>Info:</strong> Please check the&nbsp;<a
          class="text-primary"
          href="https://www.finicalinc.com/app_crm/index.phpdemo/Finicalinc CRM-html-bootstrap-admin-template/documentation/documentation-layouts.html#layout-without-menu"
          target="_blank"
